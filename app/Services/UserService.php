...
class UserService implements UserServiceInterface
{
    ...
    public function GetUsersService()
    {
        try {
            ...
            if(count($users) > 0) {
                return Helper::GetResponse(200, 'All users are succesfully appeared!', $users);
            } else {
    ...
    public function GetUserService($username)
    {
        try {
            ...
            if($user) {
                return Helper::GetResponse(200, 'A user data is succesfully appeared!', $user);
            } else {
        ...
        try {
            ...
            if($user) {
                ...
                if($request->password != $request->confirm_password) {
                    return Helper::GetResponse(400, 'A password must be same like confirm password!');
                } else {
    ...
    public function DeleteUserService($username)
    {
        try {
            ...
            if($user) {
                ...
                return Helper::GetResponse(200, 'A user data is succesfully deleted!');
            } else {
                return Helper::GetResponse(400, 'A user data is empty!');
            }
        } catch(Throwable $e) {
