...
import useCashTransactionsStore from "../../stores/cashTransaction";
            ...
            <div className="relative overflow-x-auto bg-neutral-primary-soft shadow-xs rounded-base border border-default mt-5">
                <div className="p-4 flex items-center justify-between space-x-4">
                    ...
                    <div className="relative">
                        ...
                        <SearchInput
                            onSearch={(value) => GetCashTransactions(1, value)}
                        />
                    </div>
                    <button
                        type="button"
                ...
                <TablePagination
                    ...
                    onPageChange={(page) => GetCashTransactions(page)}
                />
            </div>
